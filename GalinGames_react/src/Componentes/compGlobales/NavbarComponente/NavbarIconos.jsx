...
export function IconoBusqueda() {
  return (
    <svg className="navbar__icono" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" aria-hidden="true">
...
export function IconoGlobo() {
  return (
    <svg className="navbar__icono" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" aria-hidden="true">
